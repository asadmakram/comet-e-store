...
import { Card, InputGroup, Button, Carousel, Container, Row } from 'react-bootstrap';
import Product from '../components/Product';
import Stylo from '../images/1.jpg';
import Stylo2 from '../images/2.jpg';
import Stylo3 from '../images/3.jpg';
...
const Home = () => {
  ...
  for (let num = 0; num < 8; num++) {
    newItems[num] = {
      name: 'name' + num,
      image: num%2 == 0?  Stylo : Stylo2,
      price: 12.55 * num/20,
      description:
        'lorem ipsum lsldf lorelmo lbilk;aiojnnbiulklkniubhu aiosdhf aosidjf sldfjlalksdf lksjdfl alkhdfi dfjasld lkfjifein aldslldfi ',
    };
  }
  ...
  return (
    <Container>
      <Row>
        <h1>Welcome to Comet Store</h1>
      </Row>
      <Row>
        <Carousel>
          <Carousel.Item>
            <img className='d-block w-100' src={Stylo} alt='First slide' />
          </Carousel.Item>
          <Carousel.Item>
            <img className='d-block w-100' src={Stylo2} alt='First slide' />
          </Carousel.Item>
          <Carousel.Item>
            <img className='d-block w-100' src={Stylo3} alt='First slide' />
          </Carousel.Item>
        </Carousel>
      </Row>
      <Row>
        <div>{newItems.map((x) => x.category)}</div>
